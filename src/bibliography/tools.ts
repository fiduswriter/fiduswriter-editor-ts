...
export function litToText(litStringArray: LitString[]): string {
    let outText = ""
...
function nameListItemToString(nameListItem: NameListItem): string {
    let nameString = ""
...
export function nameToText(nameList: NameListItem[]): string {
    let nameString
