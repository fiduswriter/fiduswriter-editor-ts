...
export const peopleTabTemplate = ({
    contacts,
    collaborators
}: {
    contacts: Contact[]
...
export const shareTokenListTemplate = ({tokens}: {tokens: ShareToken[]}) => {
    if (!tokens.length) {
...
export const shareTokenRowTemplate = ({token}: {token: ShareToken}) => {
...
export const contactsTemplate = ({contacts}: {contacts: Contact[]}) =>
    contacts
        .map(
            contact =>
                `<tr>
...
export const collaboratorsTemplate = ({
    collaborators
}: {
    collaborators: Collaborator[]
}) =>
