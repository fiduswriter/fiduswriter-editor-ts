...
export class SearchReplaceDialog {
    ...
    init(): void {
                ...
                },
                {
                    ...
                    click: () => {
                        ...
                        if (this.fnMatches.matches.length) {
                            const tr = (this.editor.mod as any).footnotes
        ...
        }) as InstanceType<typeof Dialog>

        this.dialog.open()

        this.searchInput = this.dialog.dialogEl.querySelector(
            ".fw-search"
        ) as HTMLInputElement
        this.replaceInput = this.dialog.dialogEl.querySelector(
            ".replace"
        ) as HTMLInputElement
    ...
    search(term: string): void {
        ...
        const setSearchTermResultFn = setSearchTerm(
            (this.editor.mod as any).footnotes.fnEditor.view.state,
            term,
            (this.editor.mod as any).footnotes.fnEditor.view ===
        ...
        ;(this.editor.mod as any).footnotes.fnEditor.view.dispatch(fnTr)
        this.editor.view.dispatch(tr)
        this.updateResultCount()
    }
    ...
    endSearch(): void {
        ...
        ;(this.editor.mod as any).footnotes.fnEditor.view.dispatch(
            endSearch((this.editor.mod as any).footnotes.fnEditor.view.state)
        )
    }
}
