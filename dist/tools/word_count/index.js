...
export class WordCountDialog {
    ...
    countWords() {
        const textContent = getNonDeletedTextContent(this.editor.view.state.doc), footnoteContent = getNonDeletedTextContent(this.editor.mod.footnotes.fnEditor.view.state.doc), bibliographyContent = document.querySelector(".doc-bibliography")?.textContent || "";
        ...
        const selectionContent = getNonDeletedTextContent(this.editor.currentView.state.doc.cut(this.editor.currentView.state.selection.from, this.editor.currentView.state.selection.to));
