export const wordCounterDialogTemplate = ({ docNumWords, docNumNoSpace, docNumChars, selectionNumWords, selectionNumNoSpace, selectionNumChars }) => `<table class="fw-data-table">
