export const deleteContactCell = (contact) => `<span class="fw-link-text delete-single-contact"
            data-type="${contact.type}" data-id="${contact.id}">
        <i class="fa fa-trash-alt"></i>
    </span>`;
//template for contact adding dialog
export const addContactTemplate = () => `<table class="ui-dialog-content-table"><tbody><tr><td>
...
export const respondInviteCell = (contact) => `<button class="fw-button fw-small fw-dark respond-invite" data-id="${contact.id}">
    ${gettext("Respond")}
</button>`;
