...
const selectedNode = (editor) => editor.currentView.state.selection.node;
    ...
    content: [
        {
            ...
            disabled: (editor) => !(selectedNode(editor)?.type.name === "figure") ||
                selectedNode(editor)?.attrs.track?.find((track) => track.type === "deletion")
        },
        {
