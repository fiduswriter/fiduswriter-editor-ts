...
export const peopleTabTemplate = ({ contacts, collaborators }) => `<div id="my-contacts" class="fw-ar-container">
...
export const shareLinkTabTemplate = () => `<div id="share-token-list">
...
export const createShareTokenDialogTemplate = (e2ee = false, documentPassword = "") => `<table class="fw-dialog-table">
        <tbody>
            <tr>
...
export const contactsTemplate = ({ contacts }) => contacts
    .map(contact => `<tr>
...
export const collaboratorsTemplate = ({ collaborators }) => collaborators
    .map(collaborator => `<tr id="collaborator-${collaborator.holder.type}-${collaborator.holder.id}"
    ...
    class="fw-collaborator-tr" data-rights="${collaborator.rights}">
        <td width="215">
            ...
            <span class="fw-inline">${collaborator.holder.type === "userinvite"
    ? `${gettext("Invite")}: `
