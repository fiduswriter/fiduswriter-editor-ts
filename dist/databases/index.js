...
export class ModDB {
    ...
    clean() {
        ...
        const unusedImages = Object.keys(this.imageDB.db).filter(value => !usedImages.includes(Number.parseInt(value))), unusedBibs = Object.keys(this.bibDB.db).filter(value => !usedBibs.includes(Number.parseInt(value)));
        ...
        const missingImages = usedImages.filter(id => !imageDbKeys.includes(String(id)));
