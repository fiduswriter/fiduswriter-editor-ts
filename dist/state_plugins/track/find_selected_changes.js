...
export function findSelectedChanges(state) {
    const selection = state.selection, selectedChanges = {
        insertion: false,
        deletion: false,
        formatChange: false
    };
    let insertionPos = false, deletionPos = false, formatChangePos = false, insertionMark, deletionMark, formatChangeMark, insertionSize, deletionSize, formatChangeSize;
    if (selection.empty) {
...
//# sourceMappingURL=find_selected_changes.js.map