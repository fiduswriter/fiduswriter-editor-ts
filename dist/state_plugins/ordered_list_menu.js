...
export const orderedListMenuPlugin = (options) => new Plugin({
    key,
    state: {
        init(_config, _state) {
            const self = this;
            if (WRITE_ROLES.includes(options.editor.docInfo.access_rights)) {
                self.spec.props.nodeViews["ordered_list"] = (node, view, getPos) => new OrderedListView(node, view, getPos, options);
            }
            return {};
        },
        apply(_tr, prev) {
...
//# sourceMappingURL=ordered_list_menu.js.map