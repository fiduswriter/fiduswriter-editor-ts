    ...
    insertTableDialog() {
        ...
        buttons.push({
            ...
            click: () => {
                ...
                this.editor.currentView.dispatch(this.editor.currentView.state.tr.replaceSelectionWith(schema.nodeFromJSON(table), false));
                this.dialog.close();
            }
        });
        buttons.push({
...
export class TableConfigurationDialog {
    ...
    submitForm() {
        ...
        this.editor.currentView.dispatch(this.editor.currentView.state.tr.setNodeMarkup(tablePos, null, attrs));
    }
    insertDialog() {
        const buttons = [];
        buttons.push({
        ...
        this.dialog.open();
        const alignmentSelector = dropdownSelect(this.dialog.dialogEl.querySelector(".table-alignment"), {
            onChange: (newValue) => {
                if (newValue !== false) {
