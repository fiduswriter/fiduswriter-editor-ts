        ...
        buttons.push({
            ...
            click: () => {
                const dialogEl = this.dialog
                    .dialogEl;
                // Get form values
                let firstname = dialogEl.querySelector("input[name=firstname]")?.value || false, lastname = dialogEl.querySelector("input[name=lastname]")?.value || false, email = dialogEl.querySelector("input[name=email]")?.value || false, institution = dialogEl.querySelector("input[name=institution]")?.value || false, id_type = false, id_value = false;
                ...
                const view = this.view, newNode = view.state.schema.nodes.contributor.create({
                    firstname,
                    lastname,
                    email,
                    institution,
                ...
                if (this.contributor &&
                    ...
                    tr.setSelection(NodeSelection.create(tr.doc, view.state.selection.from));
                }
                else {
