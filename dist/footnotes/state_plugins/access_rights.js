...
export const accessRightsPlugin = (options) => new Plugin({
    key,
    filterTransaction: (tr, _state) => {
        ...
        if ((COMMENT_ONLY_ROLES.includes(options.editor.docInfo.access_rights) ||
...
//# sourceMappingURL=access_rights.js.map